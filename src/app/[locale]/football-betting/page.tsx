...
function FootballBettingContent() {
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {['Premier League', 'La Liga', 'Champions League'].map((league) => (
            <div key={league} className="card hover:border-gold-500/50 transition-colors">
              <h3 className="text-lg font-semibold text-gold-400 mb-2">{league}</h3>
              <p className="text-gray-400 text-sm">Match winner, Asian handicap, over/under, BTTS and more betting markets.</p>
            </div>
          ))}
        </div>
      </section>
