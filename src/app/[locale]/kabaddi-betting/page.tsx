...
function KabaddiBettingContent() {
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {['Pro Kabaddi League', 'Match Winner', 'Top Raider'].map((market) => (
            <div key={market} className="card hover:border-gold-500/50 transition-colors">
              ...
              <p className="text-gray-400 text-sm">Best odds on PKL matches with live in-play betting available.</p>
            </div>
          ))}
        </div>
      </section>
